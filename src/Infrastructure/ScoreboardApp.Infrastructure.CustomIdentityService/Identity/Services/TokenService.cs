...
namespace ScoreboardApp.Infrastructure.Identity.Services
{
    public sealed class TokenService : ITokenService
    {
        ...
        public Task<Result<TokenResponse, Error>> Refresh(RefreshRequest request)
        {
        ...
        private async Task<Result<ApplicationUser, Error>> SignInUser(string username, string password)
        {
            ...
            if (user == null)
            {
                return Result.Failure<ApplicationUser, Error>(Errors.UserNotFound);
            }
            ...
            {
                return Result.Failure<ApplicationUser, Error>(Errors.SignInFailed);
            }
